...
PyAPI_FUNC(int)  _PyRegion_PushDeferredRegion(_PyRegionObject *bridge);
PyAPI_FUNC(int)  _PyRegion_DeallocateOldestDeferredRegion(void);
PyAPI_FUNC(void) _PyRegion_DrainDeferredRegionQueue(void);
